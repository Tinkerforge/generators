...
int tf_spitfp_init(TF_SpiTfpContext *spitfp, void *hal, uint8_t port_id) TF_ATTRIBUTE_NONNULL TF_ATTRIBUTE_WARN_UNUSED_RESULT;
int tf_spitfp_destroy(TF_SpiTfpContext *spitfp) TF_ATTRIBUTE_NONNULL TF_ATTRIBUTE_WARN_UNUSED_RESULT;

uint8_t *tf_spitfp_get_payload_buffer(TF_SpiTfpContext *spitfp) TF_ATTRIBUTE_NONNULL;
uint8_t tf_spitfp_build_packet(TF_SpiTfpContext *spitfp, bool retransmission) TF_ATTRIBUTE_NONNULL;
void tf_spitfp_packet_processed(TF_SpiTfpContext *spitfp) TF_ATTRIBUTE_NONNULL;
...
int tf_spitfp_tick(TF_SpiTfpContext *spitfp, uint32_t deadline_us) TF_ATTRIBUTE_NONNULL TF_ATTRIBUTE_WARN_UNUSED_RESULT;
