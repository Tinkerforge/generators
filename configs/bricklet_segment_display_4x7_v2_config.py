...
'type': 'function',
'name': 'Set Brightness',
'elements': [('Brightness', 'uint8', 1, 'in', {'range': (0, 7), 'default': 7})],
'since_firmware': [1, 0, 0],
'doc': ['bf', {
'en':
"""
...
'type': 'function',
'name': 'Get Brightness',
'elements': [('Brightness', 'uint8', 1, 'out', {'range': (0, 7), 'default': 7})],
'since_firmware': [1, 0, 0],
'doc': ['bf', {
'en':
"""
...
'elements': [('Value', 'int8', 4, 'in', {'range': (-2, 15)})],
'since_firmware': [1, 0, 0],
'doc': ['bf', {
'en':
"""
