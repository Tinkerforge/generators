...
com['openhab'] = {
    ...
    'channel_types': [
        ...
        oh_generic_channel_type('Satellites Used', 'Number', {'en': 'Satellites Used', 'de': 'Verwendete Satelliten'},
                    update_style=None,
                    description={'en': 'The number of satellites that are currently used.',
                                 'de': 'Die Anzahl der derzeit verendeten Satelliten'}),
