...
com['examples'].append({
'name': 'Input',
'functions': [('getter', ('Get Value', 'value as bitmask'), [(('Value Mask', 'Value Mask'), 'uint8:bitmask:4', 1, None, None, None, None)], [])]
})
...
com['examples'].append({
'name': 'Interrupt',
'functions': [('callback', ('Interrupt', 'interrupt'), [(('Interrupt Mask', 'Interrupt Mask'), 'uint8:bitmask:4', 1, None, None, None, None), (('Value Mask', 'Value Mask'), 'uint8:bitmask:4', 1, None, None, None, None)], None, None),
