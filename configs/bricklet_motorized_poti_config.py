...
# Motorized Poti Bricklet communication config
...
'elements': [('Position', 'uint16', 1, 'out'),
             ('Disable After Reach', 'bool', 1, 'out')],
'since_firmware': [1, 0, 0],
'doc': ['bf', {
'en':
"""
...
# TODO: Add API: Max Motor Position Offset (1-X)
