...
'en':
"""
Sets the period with which the :cb:`Pressure` callback is triggered
...
'de':
"""
Setzt die Periode mit welcher der :cb:`Pressure` Callback ausgelöst wird.
...
'de':
"""
Gibt die Periode zurück, wie von :func:`Set Pressure Callback Period` gesetzt.
"""
}]
})
...
'de':
"""
Gibt den Schwellwert zurück, wie von :func:`Set Pressure Callback Threshold` gesetzt.
"""
}]
})
