...
com['openhab'] = {
    ...
    'channels': [
        ...
        },
        {
            ...
            'setters': [{
                    ...
                    'packet': 'Set RGB Values',
                    'packet_params': ['Helper.parseLED1ValueIndex(cmd.toString(), false, logger)',
                    ...
                    'predicate': '!Arrays.asList(6, 9, 33, 36, 18, 24).contains(cfg.channelMapping)',
                    'packet': 'Set RGBW Values',
                    'packet_params': ['Helper.parseLED1ValueIndex(cmd.toString(), true, logger)',
    ...
    'channel_types': [
        ...
        oh_generic_channel_type('All LEDs', 'Color', {'en': 'All LEDs', 'de': 'Alle LEDs'},
                    ...
                    update_style=None,
                    description={'en': "This channel allows you to set a configurable amount of LEDs (up to 240 RGBW LEDs or 320 RGB LEDs) to the same color. If you want more fine-grained control over the LEDs, use the LED Values channel or the actions.",
                                 'de': "Mit diesem Channel kann eine konfigurierbare Anzahl an LEDs (bis zu 240 RGBW- bzw. 320 RGB-LEDs) auf die selbe Farbe gesetzt werden. Mit dem LED-Werte-Channel oder den Actions kann eine genauere Kontrolle umgesetzt werden."})
    ],
