...
'type': 'function',
'name': 'Get Current',
'elements': [('Current', 'int16', 1, 'out', {'scale': (1, 1000), 'unit': 'Ampere', 'range': (-12500, 12500)})],
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set Analog Value Callback Period`. The :word:`parameter` is the analog value
of the sensor.
...
com['openhab'] = {
    ...
    'channel_types': [
        ...
        oh_generic_channel_type('Over Current', 'Switch', {'en': 'Over Current', 'de': 'Überstrom'},
                    update_style=None,
                    description={'en': 'Enabled if more than 12.5A were measured. To reset this value you have to power cycle the Bricklet.',
                                 'de': 'Aktiviert, wenn mehr als 12,5A gemessen wurden. Um diesen Wert zurückzusetzen ist ein Aus- und Wiedereinschalten des Bricklet notwendig.'}),
