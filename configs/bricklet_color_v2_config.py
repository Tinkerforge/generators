...
com['openhab'] = {
    ...
    'channels': [
        ...
        oh_generic_channel('Illuminance', 'Illuminance', divisor='cfg.gain * cfg.integrationTime / 700.0'),
        oh_generic_channel('Color Temperature', 'Color Temperature'),
        {
            'id': 'Light',
            'type': 'Light',
            'getters': [{
    ...
    'channel_types': [
        ...
        oh_generic_channel_type('Light', 'Switch', {'en': 'Light', 'de': 'Light'},
                    update_style=None,
