...
com['examples'].append({
'name': 'Simple',
'functions': [('getter', ('Get Date Time', 'date and time'), [(('Year', 'Year'), 'uint16', 1, None, None, None, None), (('Month', 'Month'), 'uint8', 1, None, None, None, None), (('Day', 'Day'), 'uint8', 1, None, None, None, None), (('Hour', 'Hour'), 'uint8', 1, None, None, None, None), (('Minute', 'Minute'), 'uint8', 1, None, None, None, None), (('Second', 'Second'), 'uint8', 1, None, None, None, None), (('Centisecond', 'Centisecond'), 'uint8', 1, None, None, None, None), (('Weekday', 'Weekday'), 'uint8', 1, None, None, None, None)], []),
              ('getter', ('Get Timestamp', 'timestamp'), [(('Timestamp', 'Timestamp'), 'int64', 1, None, 'ms', 'ms', None)], [])]
})

com['examples'].append({
'name': 'Callback',
'functions': [('callback', ('Date Time', 'date and time'), [(('Year', 'Year'), 'uint16', 1, None, None, None, None), (('Month', 'Month'), 'uint8', 1, None, None, None, None), (('Day', 'Day'), 'uint8', 1, None, None, None, None), (('Hour', 'Hour'), 'uint8', 1, None, None, None, None), (('Minute', 'Minute'), 'uint8', 1, None, None, None, None), (('Second', 'Second'), 'uint8', 1, None, None, None, None), (('Centisecond', 'Centisecond'), 'uint8', 1, None, None, None, None), (('Weekday', 'Weekday'), 'uint8', 1, None, None, None, None), (('Timestamp', 'Timestamp'), 'int64', 1, None, None, None, None)], None, None),
