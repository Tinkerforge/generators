...
com['examples'].append({
'name': 'Simple',
'functions': [('getter', ('Get Reflectivity', 'reflectivity'), [(('Reflectivity', 'Reflectivity'), 'uint16', 1, None, None, None, None)], [])]
})

com['examples'].append({
'name': 'Callback',
'functions': [('callback', ('Reflectivity', 'reflectivity'), [(('Reflectivity', 'Reflectivity'), 'uint16', 1, None, None, None, None)], None, None),
...
'functions': [('debounce_period', 1000),
              ('callback', ('Reflectivity Reached', 'reflectivity reached'), [(('Reflectivity', 'Reflectivity'), 'uint16', 1, None, None, None, None)], None, None),
