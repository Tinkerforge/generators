...
# Silent Stepper Bricklet 2.0 communication config
...
'elements': [('Channel', 'uint8', 1, 'in', {'range': (0, 1)}),
             ...
             ('Stop Deceleration', 'uint16', 1, 'in', {'default': 0xFFFF, 'unit': 'Steps Per Second Squared'})], # amax
'since_firmware': [1, 0, 0],
'doc': ['bf', {
'en':
"""
...
'elements': [('Channel', 'uint8', 1, 'in', {'range': (0, 1)}),
             ...
             ('Stop Deceleration', 'uint16', 1, 'out', {'default': 0xFFFF, 'unit': 'Steps Per Second Squared'})], # amax
'since_firmware': [1, 0, 0],
'doc': ['bf', {
'en':
"""
...
:func:`Set All Callback Configuration`. The :word:`parameters` are: the current velocity,
the current position, the remaining steps, the stack voltage, the external
voltage and the current consumption of the stepper motor.
""",
'de':
"""
Dieser Callback wird mit der Periode, wie gesetzt mit :func:`Set All Callback Configuration`,
