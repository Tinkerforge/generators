...
'functions': [('setter', 'Set Configuration', [('uint8:constant', 7), ('uint8:constant', 1), ('int32', 0)], 'Configure transceiver for loopback mode', None),
              ('callback', ('Frame Read', 'frame read'), [(('Frame Type', 'Frame Type'), 'uint8', 1, None, None, None, None), (('Identifier', 'Identifier'), 'uint32', 1, None, None, None, None), (('Data', 'Data'), 'uint8', 8, None, None, None, None), (('Length', 'Length'), 'uint8', 1, None, None, None, None)], None, None),
