...
'functions': [('getter', ('Get Moisture Value', 'moisture value'), [(('Moisture', 'Moisture Value'), 'uint16', 1, None, None, None, None)], [])]
})

com['examples'].append({
'name': 'Callback',
# FIXME: name mismatch here because of a naming inconsistency in the API
'functions': [('callback', ('Moisture', 'moisture value'), [(('Moisture', 'Moisture Value'), 'uint16', 1, None, None, None, None)], None, None),
...
'functions': [('debounce_period', 1000),
              ('callback', ('Moisture Reached', 'moisture value reached'), [(('Moisture', 'Moisture Value'), 'uint16', 1, None, None, None, None)], None, None),
