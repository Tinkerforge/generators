...
com['openhab'] = {
    ...
    'channel_types': [
        oh_generic_channel_type('Humidity', 'Number', {'en': 'Humidity', 'de': 'Luftfeuchtigkeit'},
                    ...
                    description={'en': 'Measured relative humidity', 'de': 'Gemessene relative Luftfeuchtigkeit'}),
