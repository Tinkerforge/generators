...
'type': 'function',
'name': 'Get Voltage',
'elements': [('Voltage', 'uint16', 1, 'out', {'scale': (1, 1000), 'unit': 'Volt', 'range': (0, 42000)})],
...
'elements': [('Average', 'uint8', 1, 'in', {'range': (1, 50), 'default': 50})],
'since_firmware': [1, 0, 0],
'doc': ['af', {
'en':
"""
...
'elements': [('Average', 'uint8', 1, 'out', {'range': (1, 50), 'default': 50})],
'since_firmware': [1, 0, 0],
'doc': ['af', {
'en':
"""
