...
'elements': [('Temperature', 'int16', 1, 'out', {'scale': (1, 10), 'unit': 'Degree Celsius', 'range': (-400, 1250)})],
...
'elements': [('Temperature', 'int16', 1, 'out', {'scale': (1, 10), 'unit': 'Degree Celsius', 'range': (-700, 3800)})],
'since_firmware': [1, 0, 0],
'doc': ['bf', {
'en':
"""
...
'de':
"""
Gibt die Periode zurück, wie von :func:`Set Ambient Temperature Callback Period` gesetzt.
"""
}]
})
...
'de':
"""
Gibt die Periode zurück, wie von :func:`Set Object Temperature Callback Period` gesetzt.
"""
}]
})
...
'elements': [('Option', 'char', 1, 'in', {'constant_group': 'Threshold Option', 'default': 'x'}),
             ('Min', 'int16', 1, 'in', {'scale': (1, 10), 'unit': 'Degree Celsius', 'default': 0}),
             ('Max', 'int16', 1, 'in', {'scale': (1, 10), 'unit': 'Degree Celsius', 'default': 0})],
'since_firmware': [1, 0, 0],
'doc': ['ccf', {
'en':
"""
...
'elements': [('Option', 'char', 1, 'out', {'constant_group': 'Threshold Option', 'default': 'x'}),
             ('Min', 'int16', 1, 'out', {'scale': (1, 10), 'unit': 'Degree Celsius', 'default': 0}),
             ('Max', 'int16', 1, 'out', {'scale': (1, 10), 'unit': 'Degree Celsius', 'default': 0})],
'since_firmware': [1, 0, 0],
'doc': ['ccf', {
'en':
"""
...
'de':
"""
Gibt den Schwellwert zurück, wie von :func:`Set Ambient Temperature Callback Threshold` gesetzt.
"""
}]
})
...
'de':
"""
Gibt den Schwellwert zurück, wie von :func:`Set Object Temperature Callback Threshold` gesetzt.
"""
}]
})
...
ambient_temp_channel = oh_generic_old_style_channel('Ambient Temperature', 'Ambient Temperature', cast_literal='(short)', element_name='Temperature')
ambient_temp_channel['callbacks'][0]['transform'] = 'new {number_type}(temperature{divisor}{unit})'

object_temp_channel = oh_generic_old_style_channel('Object Temperature', 'Object Temperature', cast_literal='(short)', element_name='Temperature')
...
com['openhab'] = {
    ...
    'channel_types': [
        ...
        oh_generic_channel_type('Object Temperature', 'Number', 'Object Temperature',
                    update_style='Callback Period',
                    description='The measured object temperature, i.e. the temperature of the surface of the object the sensor is aimed at. The temperature of different materials is dependent on their `emissivity <https://en.wikipedia.org/wiki/Emissivity>`__.')
    ],
