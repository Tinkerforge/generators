...
com['openhab'] = {
    ...
    'channels': [
        {
            ...
            'setters': [{
                ...
                'element': 'Volume',
                'packet_params': ['cmd.intValue(){divisor}'],
                'command_type': "Number"
            }],
            ...
            'getters': [{
                ...
                'transform': 'new DecimalType(value.volume{divisor})'
            }, {
                'packet': 'Get Alarm',
                'element': 'Volume',
                'predicate': 'value.durationRemaining > 0',
    ...
    'channel_types': [
        ...
        oh_generic_channel_type('Alarm', 'Switch', 'Alarm',
                    update_style=None,
                    description='Creates an alarm (a tone that goes back and force between two specified frequencies). The following parameters can be set:\n\n<ul><li>Start Frequency: Start frequency of the alarm in Hz.</li><li>End Frequency: End frequency of the alarm in Hz.</li><li>Step Size: Size of one step of the sweep between the start/end frequencies in Hz.</li><li>Step Delay: Delay between two steps (duration of time that one tone is used in a sweep) in ms.</li><li>Duration: Duration of the alarm in ms.</li></ul>\n\nA duration of 0 stops the current alarm if any is ongoing. A duration of 4294967295 results in an infinite alarm.',
                    params=[{
                            'packet': 'Set Alarm',
