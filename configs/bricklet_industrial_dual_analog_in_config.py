...
com['examples'].append({
'name': 'Simple',
'functions': [('getter', ('Get Voltage', 'voltage from channel 1'), [(('Voltage', 'Voltage (Channel 1)'), 'int32', 1, 1000.0, 'mV', 'V', None)], [('uint8', 1)])]
})

com['examples'].append({
'name': 'Callback',
'functions': [('callback', ('Voltage', 'voltage'), [(('Channel', 'Channel'), 'uint8', 1, None, None, None, None), (('Voltage', 'Voltage'), 'int32', 1, 1000.0, 'mV', 'V', None)], None, None),
...
'functions': [('debounce_period', 10000),
              ('callback', ('Voltage Reached', 'voltage reached'), [(('Channel', 'Channel'), 'uint8', 1, None, None, None, None), (('Voltage', 'Voltage'), 'int32', 1, 1000.0, 'mV', 'V', None)], None, None),
