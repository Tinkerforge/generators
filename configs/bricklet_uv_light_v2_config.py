...
com['openhab'] = {
    ...
    'channels': [
        oh_generic_channel('UVA', 'UVA', 'SmartHomeUnits.IRRADIANCE', divisor=10000.0),
        oh_generic_channel('UVB', 'UVB', 'SmartHomeUnits.IRRADIANCE', divisor=10000.0),
        oh_generic_channel('UVI', 'UVI', 'SmartHomeUnits.ONE', divisor=10.0),
    ],
    'channel_types': [
        oh_generic_channel_type('UVA', 'Number:Intensity', 'UV-A Intensity',
                    ...
                    pattern='%.5f %unit%',
                    min_=0),
        oh_generic_channel_type('UVB', 'Number:Intensity', 'UV-B Intensity',
                    update_style='Callback Configuration',
                    ...
                    pattern='%.5f %unit%',
                    min_=0),
        oh_generic_channel_type('UVI', 'Number:Dimensionless', 'UV Index',
                    update_style='Callback Configuration',
