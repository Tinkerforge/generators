...
com['examples'].append({
'name': 'Simple',
'functions': [('getter', ('Get Tilt State', 'tilt state'), [(('State', 'Tilt State'), 'uint8', 1, None, None, None, None)], [])],
...
'functions': [('setter', 'Enable Tilt State Callback', [], 'Enable tilt state callback', None),
              ('callback', ('Tilt State', 'tilt state'), [(('State', 'Tilt State'), 'uint8', 1, None, None, None, None)], None, None)],
