...
# IMU Bricklet 3.0 communication config
...
:func:`Set Magnetic Field Callback Configuration` vorzugeben.
"""
}]
})
...
:func:`Set Angular Velocity Callback Configuration` vorzugeben.
"""
}]
})
...
:func:`Set Orientation Callback Configuration` vorzugeben.
"""
}]
})
...
:func:`Set Linear Acceleration Callback Configuration` vorzugeben.
"""
}]
})
...
:func:`Set Gravity Vector Callback Configuration` vorzugeben.
"""
}]
})
...
:func:`Set Quaternion Callback Configuration` vorzugeben.
"""
}]
})
...
:func:`Set All Data Callback Configuration` vorzugeben.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`Acceleration` Callback
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set Acceleration Callback Configuration` gesetzt.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`Magnetic Field` Callback
ausgelöst wird. Ein Wert von 0 schaltet den Callback ab.
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set Magnetic Field Callback Configuration` gesetzt.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`Angular Velocity` Callback
ausgelöst wird. Ein Wert von 0 schaltet den Callback ab.
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set Angular Velocity Callback Configuration` gesetzt.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`Temperature` Callback
ausgelöst wird. Ein Wert von 0 schaltet den Callback ab.
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set Temperature Callback Configuration` gesetzt.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`Orientation` Callback
ausgelöst wird. Ein Wert von 0 schaltet den Callback ab.
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set Orientation Callback Configuration` gesetzt.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`Linear Acceleration` Callback
ausgelöst wird. Ein Wert von 0 schaltet den Callback ab.
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set Linear Acceleration Callback Configuration` gesetzt.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`Gravity Vector` Callback
ausgelöst wird. Ein Wert von 0 schaltet den Callback ab.
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set Gravity Vector Callback Configuration` gesetzt.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`Quaternion` Callback
ausgelöst wird. Ein Wert von 0 schaltet den Callback ab.
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set Quaternion Callback Configuration` gesetzt.
"""
}]
})
...
'de':
"""
Die Periode ist die Periode mit der der :cb:`All Data` Callback
ausgelöst wird. Ein Wert von 0 schaltet den Callback ab.
...
'de':
"""
Gibt die Callback-Konfiguration zurück, wie mittels :func:`Set All Data Callback Configuration` gesetzt.
"""
}]
})
...
:func:`Set Acceleration Callback Configuration`. The :word:`parameters` are the acceleration
for the x, y and z axis.
""",
'de':
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set Acceleration Callback Configuration`, ausgelöst. Die :word:`parameters` sind die
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set Magnetic Field Callback Configuration`. The :word:`parameters` are the magnetic
field for the x, y and z axis.
""",
'de':
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set Magnetic Field Callback Configuration`, ausgelöst. Die :word:`parameters` sind die
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set Angular Velocity Callback Configuration`. The :word:`parameters` are the angular
velocity for the x, y and z axis.
""",
'de':
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set Angular Velocity Callback Configuration`, ausgelöst. Die :word:`parameters` sind die
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set Temperature Callback Configuration`. The :word:`parameter` is the temperature.
""",
'de':
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set Temperature Callback Configuration`, ausgelöst. Der :word:`parameter` ist die
Temperatur.
"""
}]
})
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set Linear Acceleration Callback Configuration`. The :word:`parameters` are the
linear acceleration for the x, y and z axis.
""",
'de':
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set Linear Acceleration Callback Configuration`, ausgelöst. Die :word:`parameter` sind
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set Gravity Vector Callback Configuration`. The :word:`parameters` gravity vector
for the x, y and z axis.
""",
'de':
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set Gravity Vector Callback Configuration`, ausgelöst. Die :word:`parameter` sind die
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set Orientation Callback Configuration`. The :word:`parameters` are the orientation
...
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set Orientation Callback Configuration`, ausgelöst. Die :word:`parameters` sind die
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set Quaternion Callback Configuration`. The :word:`parameters` are the orientation
...
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set Quaternion Callback Configuration`, ausgelöst. Die :word:`parameters` sind die
...
"""
This callback is triggered periodically with the period that is set by
:func:`Set All Data Callback Configuration`. The :word:`parameters` are as for
:func:`Get All Data`.
""",
'de':
"""
Dieser Callback wird mit der Periode, wie gesetzt mit
:func:`Set All Data Callback Configuration`, ausgelöst. Die :word:`parameter` sind die
...
com['openhab'] = {
    ...
    'params': [{
            ...
            'description': "If the fusion mode is turned off, the Acceleration, Magnetic Field and Angular Velocity channels return uncalibrated and uncompensated sensor data. All other sensor channels return no data.\n\nSince firmware version 2.0.6 you can also use a fusion mode without magnetometer. In this mode the calculated orientation is relative (with magnetometer it is absolute with respect to the earth). However, the calculation can't be influenced by spurious magnetic fields.\n\nSince firmware version 2.0.13 you can also use a fusion mode without fast magnetometer calibration. This mode is the same as the normal fusion mode, but the fast magnetometer calibration is turned off. So to find the orientation the first time will likely take longer, but small magnetic influences might not affect the automatic calibration as much.\n\nBy default sensor fusion is on."
        },
        update_interval('Set Acceleration Callback Configuration', 'Period', 'Acceleration', 'the acceleration'),
        update_interval('Set Magnetic Field Callback Configuration', 'Period', 'Magnetic Field', 'the magnetic field'),
        update_interval('Set Angular Velocity Callback Configuration', 'Period', 'Angular Velocity', 'the angular velocity'),
        update_interval('Set Orientation Callback Configuration', 'Period', 'Orientation', 'the orientation as euler angles'),
        update_interval('Set Quaternion Callback Configuration', 'Period', 'Quaternion', 'the orientation as quaternion'),
        update_interval('Set Linear Acceleration Callback Configuration', 'Period', 'Linear Acceleration', 'the linear acceleration'),
        update_interval('Set Gravity Vector Callback Configuration', 'Period', 'Gravity Vector', 'the gravity vector'),
        update_interval('Set Temperature Callback Configuration', 'Period', 'Temperature', 'the temperature'),
        ],
    'param_groups': oh_generic_channel_param_groups(),
    'init_code': """
    this.setAccelerationCallbackConfiguration(cfg.accelerationUpdateInterval, true);
    this.setMagneticFieldCallbackConfiguration(cfg.magneticFieldUpdateInterval, true);
    this.setAngularVelocityCallbackConfiguration(cfg.angularVelocityUpdateInterval, true);
    this.setOrientationCallbackConfiguration(cfg.orientationUpdateInterval, true);
    this.setQuaternionCallbackConfiguration(cfg.quaternionUpdateInterval, true);
    this.setLinearAccelerationCallbackConfiguration(cfg.linearAccelerationUpdateInterval, true);
    this.setGravityVectorCallbackConfiguration(cfg.gravityVectorUpdateInterval, true);
    this.setTemperatureCallbackConfiguration(cfg.temperatureUpdateInterval, true);
    ...
    'actions': ['Get Orientation', 'Get Linear Acceleration', 'Get Gravity Vector', 'Get Quaternion', 'Get All Data', 'Get Acceleration', 'Get Magnetic Field', 'Get Angular Velocity', 'Get Temperature', 'Get Sensor Configuration', 'Get Sensor Fusion Mode']
}
