...
class JuliaPyZipGenerator(juliapy_common.JuliaPyGeneratorTrait, common.ZipGenerator):
    ...
    def finish(self):
        ...
        shutil.copy(os.path.join(root_dir, 'PyTinkerforge.jl'),               self.tmp_source_dir)
...
def generate(root_dir, language, internal):
    common.generate(root_dir, language, internal, JuliaPyZipGenerator)
