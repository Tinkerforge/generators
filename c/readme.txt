...
dependencies that are available on nearly everywhere, thus making it
...
operating systems (Windows, Unix-like systems such as linux and Mac
OS, etc.).
...
bindings (ip_connection.h, ip_connection.c, stepper_brick.c and and
...
compilation of the project with gcc on linux or mac os looks like:

gcc -lpthread -o example_configuration brick_stepper.c ip_connection.c example_configuration.c

On Windows WinThreads???? are used.... TODO
