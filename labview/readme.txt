...
vi.lib folder of your LabVIEW installation (for example:
C:\Program Files\National Instruments\LabVIEW 2013\vi.lib\) or you can put it
in the same folder as the example you want to test. In both cases LabVIEW will
find the Tinkerforge.dll automatically and does not ask for your support. But
