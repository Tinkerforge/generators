(function e(t, n, r) {
    ...
    }, { "core-js/shim": 181, "regenerator/runtime": 182 }],
    ...
    }, { "./$.to-index": 69, "./$.to-iobject": 71, "./$.to-length": 72 }],
    ...
    }, { "./$.ctx": 15, "./$.iobject": 31, "./$.to-length": 72, "./$.to-object": 73 }],
    ...
    }, { "./$.enum-keys": 19, "./$.fails": 21, "./$.iobject": 31, "./$.to-object": 73 }],
    ...
    }, { "./$": 41, "./$.core": 14, "./$.ctx": 15, "./$.defined": 17, "./$.for-of": 24, "./$.has": 27, "./$.hide": 28, "./$.is-object": 34, "./$.iter-define": 37, "./$.iter-step": 39, "./$.mix": 46, "./$.species": 59, "./$.strict-new": 60, "./$.support-desc": 66, "./$.uid": 74 }],
    ...
    }, { "./$.an-object": 4, "./$.array-methods": 6, "./$.for-of": 24, "./$.has": 27, "./$.hide": 28, "./$.is-object": 34, "./$.mix": 46, "./$.strict-new": 60, "./$.uid": 74 }],
            ...
            var fixMethod = function(KEY) {
                ...
                require('./$.redef')(proto, KEY,
                    KEY == 'delete' ? function(a) {
                        return fn.call(this, a === 0 ? 0 : a); } : KEY == 'has' ? function has(a) {
                        return fn.call(this, a === 0 ? 0 : a); } : KEY == 'get' ? function get(a) {
                        return fn.call(this, a === 0 ? 0 : a); } : KEY == 'add' ? function add(a) { fn.call(this, a === 0 ? 0 : a);
                        return this; } : function set(a, b) { fn.call(this, a === 0 ? 0 : a, b);
                        return this; }
                );
            };
    ...
    }, { "./$.def": 16, "./$.fails": 21, "./$.for-of": 24, "./$.global": 26, "./$.iter-detect": 38, "./$.mix": 46, "./$.redef": 53, "./$.strict-new": 60, "./$.tag": 67 }],
    ...
    16: [function(require, module, exports) {
        ...
        $def.W = 32; // wrap
        module.exports = $def;
    }, { "./$.core": 14, "./$.global": 26, "./$.hide": 28, "./$.redef": 53 }],
    ...
    }, { "./$.defined": 17, "./$.fails": 21, "./$.hide": 28, "./$.redef": 53, "./$.wks": 76 }],
    ...
    }, { "./$.an-object": 4, "./$.ctx": 15, "./$.is-array-iter": 32, "./$.iter-call": 35, "./$.to-length": 72, "./core.get-iterator-method": 77 }],
    ...
    }, { "./$": 41, "./$.property-desc": 52, "./$.support-desc": 66 }],
    ...
    }, { "./$": 41, "./$.hide": 28, "./$.property-desc": 52, "./$.tag": 67, "./$.wks": 76 }],
    ...
    }, { "./$": 41, "./$.def": 16, "./$.has": 27, "./$.hide": 28, "./$.iter-create": 36, "./$.iterators": 40, "./$.library": 43, "./$.redef": 53, "./$.tag": 67, "./$.wks": 76 }],
    ...
    }, { "./$.a-function": 3, "./$.invoke": 30, "./$.path": 51 }],
    ...
    }, { "./$.core": 14, "./$.global": 26, "./$.hide": 28, "./$.uid": 74 }],
    ...
    }, { "./$": 41, "./$.an-object": 4, "./$.ctx": 15, "./$.is-object": 34 }],
    ...
    }, { "./$.defined": 17, "./$.string-repeat": 64, "./$.to-length": 72 }],
    ...
    }, { "./$.cof": 9, "./$.ctx": 15, "./$.dom-create": 18, "./$.global": 26, "./$.html": 29, "./$.invoke": 30 }],
    ...
    }, { "./$.classof": 8, "./$.core": 14, "./$.iterators": 40, "./$.wks": 76 }],
    78: [function(require, module, exports) {
        ...
        var date = new Date(-5e13 - 1),
            brokenDate = !(date.toISOString && date.toISOString() == '0385-07-25T07:06:39.999Z' && fails(function() { new Date(NaN).toISOString(); }));
    ...
    }, { "./$": 41, "./$.a-function": 3, "./$.an-object": 4, "./$.array-includes": 5, "./$.array-methods": 6, "./$.cof": 9, "./$.def": 16, "./$.dom-create": 18, "./$.fails": 21, "./$.has": 27, "./$.html": 29, "./$.invoke": 30, "./$.iobject": 31, "./$.is-object": 34, "./$.property-desc": 52, "./$.support-desc": 66, "./$.to-index": 69, "./$.to-integer": 70, "./$.to-iobject": 71, "./$.to-length": 72, "./$.to-object": 73, "./$.uid": 74 }],
    ...
    }, { "./$.def": 16, "./$.to-index": 69, "./$.to-length": 72, "./$.to-object": 73, "./$.unscope": 75 }],
    ...
    81: [function(require, module, exports) {
        ...
        require('./$.unscope')(KEY);
    }, { "./$.array-methods": 6, "./$.def": 16, "./$.unscope": 75 }],
    ...
    }, { "./$.ctx": 15, "./$.def": 16, "./$.is-array-iter": 32, "./$.iter-call": 35, "./$.iter-detect": 38, "./$.to-length": 72, "./$.to-object": 73, "./core.get-iterator-method": 77 }],
    84: [function(require, module, exports) {
        ...
        setUnscope('values');
        setUnscope('entries');
    }, { "./$.iter-define": 37, "./$.iter-step": 39, "./$.iterators": 40, "./$.to-iobject": 71, "./$.unscope": 75 }],
    ...
    }, { "./$": 41, "./$.has": 27, "./$.property-desc": 52, "./$.support-desc": 66 }],
        ...
        if (!($Number('0o1') && $Number('0b1'))) {
            $Number = function Number(it) {
                ...
                return that instanceof $Number
                    ...
                    && (BROKEN_COF ? fails(function() { proto.valueOf.call(that); }) : cof(that) != NUMBER) ? new Base(toNumber(it)) : toNumber(it);
            };
    ...
    }, { "./$": 41, "./$.cof": 9, "./$.fails": 21, "./$.global": 26, "./$.has": 27, "./$.is-object": 34, "./$.redef": 53, "./$.support-desc": 66 }],
    ...
    }, { "./$.object-sap": 47, "./$.to-iobject": 71 }],
    120: [function(require, module, exports) {
        // 19.1.2.7 Object.getOwnPropertyNames(O)
        require('./$.object-sap')('getOwnPropertyNames', function() {
            return require('./$.get-names').get;
        });
    }, { "./$.get-names": 25, "./$.object-sap": 47 }],
    ...
    131: [function(require, module, exports) {
        ...
        $def($def.S + $def.F * (!useNative || testResolve(true)), PROMISE, {
            ...
            resolve: function resolve(x) {
                return isPromise(x) && sameConstructor(x.constructor, this) ? x : new this(function(res) { res(x); });
            }
        });
    ...
    }, { "./$": 41, "./$.a-function": 3, "./$.an-object": 4, "./$.classof": 8, "./$.core": 14, "./$.ctx": 15, "./$.def": 16, "./$.for-of": 24, "./$.global": 26, "./$.is-object": 34, "./$.iter-detect": 38, "./$.library": 43, "./$.microtask": 45, "./$.mix": 46, "./$.same": 55, "./$.set-proto": 56, "./$.species": 59, "./$.strict-new": 60, "./$.support-desc": 66, "./$.tag": 67, "./$.uid": 74, "./$.wks": 76 }],
    ...
    }, { "./$": 41, "./$.a-function": 3, "./$.an-object": 4, "./$.core": 14, "./$.def": 16, "./$.fails": 21, "./$.is-object": 34 }],
    ...
    }, { "./$": 41, "./$.an-object": 4, "./$.def": 16, "./$.fails": 21 }],
    ...
    }, { "./$.an-object": 4, "./$.def": 16, "./$.iter-create": 36 }],
    ...
    }, { "./$": 41, "./$.an-object": 4, "./$.def": 16, "./$.has": 27, "./$.is-object": 34 }],
    ...
    }, { "./$": 41, "./$.an-object": 4, "./$.def": 16, "./$.has": 27, "./$.is-object": 34, "./$.property-desc": 52 }],
    ...
    }, { "./$": 41, "./$.cof": 9, "./$.flags": 23, "./$.global": 26, "./$.redef": 53, "./$.species": 59, "./$.support-desc": 66 }],
    ...
    }, { "./$.def": 16, "./$.fails": 21, "./$.string-context": 62, "./$.to-length": 72 }],
    ...
    }, { "./$.def": 16, "./$.to-iobject": 71, "./$.to-length": 72 }],
    ...
    162: [function(require, module, exports) {
        ...
        if (!useNative || require('./$.fails')(function() {
                return JSON.stringify([{ a: $Symbol() },
                    [$Symbol()]
                ]) != '[{},[null]]';
    ...
    }, { "./$": 41, "./$.an-object": 4, "./$.def": 16, "./$.enum-keys": 19, "./$.fails": 21, "./$.get-names": 25, "./$.global": 26, "./$.has": 27, "./$.is-object": 34, "./$.keyof": 42, "./$.library": 43, "./$.property-desc": 52, "./$.redef": 53, "./$.shared": 57, "./$.support-desc": 66, "./$.tag": 67, "./$.to-iobject": 71, "./$.uid": 74, "./$.wks": 76 }],
    ...
    }, { "./$": 41, "./$.collection": 13, "./$.collection-weak": 12, "./$.has": 27, "./$.is-object": 34, "./$.redef": 53 }],
    ...
    }, { "./$.array-includes": 5, "./$.def": 16, "./$.unscope": 75 }],
    166: [function(require, module, exports) {
        // https://github.com/DavidBruant/Map-Set.prototype.toJSON
        var $def = require('./$.def');

        $def($def.P, 'Map', { toJSON: require('./$.collection-to-json')('Map') });
    }, { "./$.collection-to-json": 11, "./$.def": 16 }],
    ...
    }, { "./$": 41, "./$.def": 16, "./$.own-keys": 49, "./$.property-desc": 52, "./$.to-iobject": 71 }],
    ...
    }, { "./$.global": 26, "./$.hide": 28, "./$.iterators": 40, "./$.wks": 76, "./es6.array.iterator": 84 }],
    ...
    }, { "./$.def": 16, "./$.global": 26, "./$.invoke": 30, "./$.partial": 50 }],
