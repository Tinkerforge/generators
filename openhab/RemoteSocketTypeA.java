...
public class RemoteSocketTypeA extends DeviceWrapper {
    ...
    public static ThingType getThingType(ThingTypeUID thingTypeUID) {
        return ThingTypeBuilder.instance(thingTypeUID, "Tinkerforge Remote Socket Type A").isListed(true)
                ...
                .withChannelDefinitions(Arrays.asList(new ChannelDefinitionBuilder("RemoteSocketTypeACommand",
    ...
    public static ConfigDescription getConfigDescription(URI uri) {
        ...
        case "thing-type:tinkerforge:remotesockettypea":
            return ConfigDescriptionBuilder.create(uri).withParameters(Arrays.asList(
                    ConfigDescriptionParameterBuilder.create("houseCode", Type.INTEGER).withDefault("0")
                            .withDescription("The house code of the remote socket to control.")
                            .withMinimum(BigDecimal.valueOf(0)).withMaximum(BigDecimal.valueOf(31)).build(),
                    ConfigDescriptionParameterBuilder.create("receiverCode", Type.INTEGER).withDefault("0")
