...
from generators.java.generate_java_bindings import JavaBindingsGenerator, JavaBindingsDevice
...
def generate(root_dir, language, internal):
    common.generate(root_dir, language, internal, OpenHABBindingsGenerator)
