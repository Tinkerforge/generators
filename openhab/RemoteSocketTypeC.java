...
public class RemoteSocketTypeC {
    ...
    public final static DeviceInfo DEVICE_INFO = new DeviceInfo(DEVICE_DISPLAY_NAME, "remotesockettypec",
            DEVICE_IDENTIFIER, RemoteSocketTypeC.class, DefaultActions.class, "1.0.0");
    ...
    public static ChannelType getChannelType(ChannelTypeUID channelTypeUID) {
        ...
        case "RemoteSocketTypeCCommand":
            return ChannelTypeBuilder
                    .state(new ChannelTypeUID("tinkerforge", "RemoteSocketTypeCCommand"), "Command",
                            "String")
    ...
    public static ThingType getThingType(ThingTypeUID thingTypeUID) {
        return ThingTypeBuilder.instance(thingTypeUID, "Tinkerforge Remote Socket Type C").isListed(true)
                ...
                .withDescription("Remote controlled mains switch (Type C) for Remote Switch Bricklet or Remote Switch Bricklet 2.0")
                .withChannelDefinitions(Arrays.asList(
                        new ChannelDefinitionBuilder("RemoteSocketTypeCCommand",
                        ...
                        Arrays.asList(
                            ConfigDescriptionParameterBuilder
                                ...
                                .withOptions(Arrays.asList(
                                    new ParameterOption("A", "A"),
                                    new ParameterOption("B", "B"),
                                    new ParameterOption("C", "C"),
                                    new ParameterOption("D", "D"),
                                    new ParameterOption("E", "E"),
                                    new ParameterOption("F", "F"),
                                    new ParameterOption("G", "G"),
                                    new ParameterOption("H", "H"),
                                    new ParameterOption("I", "I"),
                                    new ParameterOption("J", "J"),
                                    new ParameterOption("K", "K"),
                                    new ParameterOption("L", "L"),
                                    new ParameterOption("M", "M"),
                                    new ParameterOption("N", "N"),
                                    new ParameterOption("O", "O"),
                                    new ParameterOption("P", "P")))
                                .build(),
                            ConfigDescriptionParameterBuilder
                                .create("deviceCode", Type.INTEGER)
                                .withDefault("1")
        ...
        switch(channel) {
            ...
            if (command instanceof StringType) {
                    ...
                    handler.enqueue(new Task(
                        ...
                        success -> {
                            if(!success)
                                logger.warn("Address {} Unit {} command {} failed", cfg.systemCode.charAt(0), cfg.deviceCode, cmd.toString());
                        }));
                }
